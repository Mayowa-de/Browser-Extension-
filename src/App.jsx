...
function App() {
  ...
  return (
    <div aria-details="parent-container" className="dark:bg-[hsl(227,75%,14%)] pb-7 w-full h-full bg-[linear-gradient(180deg,_#EBF2FC_0%,_#EEF8F9_100%)] gap-5 p-4 flex flex-col">
      <Hero />
