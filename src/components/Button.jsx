      ...
      {cards.map((card, i) => (
        ...
        >
          ...
          <div className="flex justify-between">
            ...
            <button aria-label="toggle icon" onClick={() => onToggle(card.id)} className=" text-4xl cursor-pointer">
              {card.isActive ? (
